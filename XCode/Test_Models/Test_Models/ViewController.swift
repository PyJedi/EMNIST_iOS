...
public class ViewController: UIViewController {
    ...
    let model1 = emnist_model1_FP32_2()
    let model2 = emnist_model1_FP16_2()
    let model3 = emnist_model1_FP8_2()
    ...
    public lazy var predbutton: UIButton = {
        ...
        predbutton.setImage(UIImage(named: "predict_button.png"), for: .normal)
    ...
    public lazy var clearbutton: UIButton = {
        ...
        clearbutton.setImage(UIImage(named: "pred_clear.png"), for: .normal)
    ...
    @objc func predbuttontapped(_ sender: UIButton){
        ...
        guard let result = try? model1.prediction(input1: buffer) else { return }
